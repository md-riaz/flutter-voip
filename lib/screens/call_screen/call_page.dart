...
import 'package:flutter_voip/component/button/action_button.dart';
import 'package:flutter_voip/component/button/icon_text_button.dart';
import 'package:flutter_voip/flutter_voip.dart';
import 'package:flutter_voip/utils/audio_helper.dart';
  ...
  Widget _buildContent() {
    ...
    if (!voiceonly &&
      ...
      stackWidgets.add(Center(
        child: VoipRTCVideoView(pitelCall.remoteRenderer!),
      ));
    }
    ...
    if (!voiceonly &&
      ...
      stackWidgets.add(Container(
        ...
        child: AnimatedContainer(
          ...
          child: VoipRTCVideoView(pitelCall.localRenderer!),
        ),
      ));
    }
